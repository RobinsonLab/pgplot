...
C     CALL GRPS02(IOERR, UNIT, '0.072 0.072 scale')
C changes to scale factors
      CALL GRPS02(IOERR, UNIT, '0.062 0.062 scale')
      LANDSC = MODE.EQ.1 .OR. MODE.EQ.3
C changes to offw and offh
	OFFW=OFFW+1000
	OFFH=OFFH+750
      IF (LANDSC) THEN
